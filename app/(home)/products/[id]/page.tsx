...
const ProductPage = () => {
  ...
  const productDescription = isOpen
    ? currentProduct.description
    : cropText(currentProduct.description, 100);
        ...
        <div className="flex flex-col gap-3 flex-1">
          ...
          {user?.isAdmin ? (
            <div className="flex items-center gap-2">
              ...
              <Button asChild>
                <Link
                  href={`/admin/products/edit/${currentProduct.id}`}
                  className="flex items-center gap-2"
                >
                  <span>Edit</span>
                  <LayoutDashboard />
            ...
            <Button
              ...
              onClick={() => handleAddItemToCart(currentProduct)}
            >
              <div className="flex items-center gap-2">
                <span>Add To Cart</span>
                <ShoppingCart />
