...
const ProductCard :FC<IProductCard>= ({price, description, image, title, children, link}) => {
    return (
        <Link href={link} className='border-2 shadow-xl rounded-xl flex flex-col gap-3 p-3 group cursor-pointer'>
